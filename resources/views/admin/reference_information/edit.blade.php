        ...
        <div class="row row-cards">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="{{ route('admin.reference_information.update',[$reference_information->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control w-100" value="{{ $reference_information->reference_title }}" name="reference_title" >
                        </div>


                        <div class="form-group w-100">
                            <label class="form-label">Descripition</label>
                            <textarea class="form-control w-100" name="reference_descripition"  rows="7">{!! $reference_information->reference_descripition !!}</textarea>
                        </div>
