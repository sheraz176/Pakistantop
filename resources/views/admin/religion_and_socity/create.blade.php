            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Create Religion and Socity</div>
                    </div>

                    <form action="{{ route('admin.religion_and_socity.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div class="card-body">
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control w-100" required name="title" placeholder="Enter Title here">
                        </div>

                        <div class="form-group ">
                            <label class="form-label">Enter Intro</label>
                            <input type="text" class="form-control w-100" required name="intro" placeholder="Enter Intro">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="icon" style="margin-top: 30px" required value="{{$icon->id}}" ><img class="mt-2" style="height: 53px;" src="{{$icon->url}}" alt="">
                              </label>
