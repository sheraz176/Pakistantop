...
@section('title')
    <title>Places | Religionmap</title>
@endsection
@push('styles')
    <!-- Data table css -->
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button type="button" class="btn btn-success btn-sm" ><a Style="color:white;" href="{{ route('admin.places.create') }}">Create Place</a></button>
    ...
    $(function () {
      ...
      var table = $('.data-table').DataTable({
          ...
          columns: [
              ...
              {data: 'confession_type', name: 'confession_type'},
