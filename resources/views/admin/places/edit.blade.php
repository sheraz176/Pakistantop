                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Edit Place</div>
                            </div>

                            <form action="{{ route('admin.places.update',$place->id) }}" method="POST" id="place-form"
                                enctype="multipart/form-data">
                                @csrf

                                <input type="hidden" name="lat" id="lat" value="{{$place->lat}}">
                                <input type="hidden" name="lng" id="lng" value="{{$place->lng}}">
                                <input type="hidden" name="map_name" id="map_name" {{$place->map_area_name}}>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                <label class="form-label">Enter Title  <span style="color: red">*</span></label>
                                                <input type="text" class="form-control w-100" name="title" id="title" value="{{$place->title}}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" class="form-control w-100" name="phone_no" id="phone_no" value="{{$place->phone_no}}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                ...
                                                <input type="email" class="form-control w-100" name="email" id="email"
                                                    placeholder="Enter email here" value="{{$place->email}}" >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="{{!empty($place->image)?'col-md-8':'col-md-12'}}">
                                                    <div class="form-group ">
                                                ...
                                                <div class="col-md-4">
                                                    <img src="{{Storage::url($place->image)}}" alt=""height="100px" width="150px" class="thumbnail">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                               ...
                                               <select  class="form-control" name="confession_type" id="confession_type" required>
                                                ...
                                                <option value="{{$religion->id}}" {{$place->confession_type == $religion->id ? 'selected':'' }}>{{$religion->title}}</option>
                                                @endforeach
                                               </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                               ...
                                               <select  class="form-control" name="building_type" id="building_type" required>
                                                ...
                                                <option value="religious_building" {{$place->building_type == 'religious_building'?'selected':''}}>religious building</option>
                                                <option value="literature_and_paraphernalia" {{$place->building_type == 'literature_and_paraphernalia'?'selected':''}}>Places of sale of religious literature and paraphernalia</option>
                                                <option value="prayer_room" {{$place->building_type == 'prayer_room'?'selected':''}}>prayer room</option>
                                               </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                               ...
                                               <select  class="form-control" name="area_type" id="area_type" required>
                                                ...
                                                <option value="{{$area->id}}" {{$place->area_type == $area->id?'selected':''}}>{{$area->name}}</option>
                                                @endforeach
                                               </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="content" name="description" placeholder="Enter Description" id="description">{{$place->description}}</textarea>
                                    </div>
                                ...
                                <div class="card-footer">
                                    <span class="btn btn-primary waves-effect waves-light" onclick="submit()">Update</span>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            @push('scripts')
                ...
                <script>
                    function submit() {
                        ...
                        if (lat && lng && map_name && confession_type  && area_type &&  building_type && title ) {
                            $('#place-form').submit();
                        } else {
