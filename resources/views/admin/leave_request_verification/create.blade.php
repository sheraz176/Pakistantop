        ...
        <div class="row row-cards">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="{{ route('admin.leave_request_verification.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div class="card-body">
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control w-100" name="full_name" placeholder="Enter Full Name">
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group ">
                            <label class="form-label">Map Object</label>
                            <input type="text" class="form-control w-100" name="map_object" placeholder="Enter Address">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="content" name="message" placeholder="Enter Message"></textarea>
                        </div>
                    </div>
