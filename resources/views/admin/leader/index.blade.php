...
@section('title')
    <title>Leaders | Religionmap</title>
@endsection
@push('styles')
    <!-- Data table css -->
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button type="button" class="btn btn-success btn-sm" ><a Style="color:white;" href="{{ route('admin.leaders.create') }}">Create Leader</a></button>
...
<script type="text/javascript">
    $(function () {
      ...
      var table = $('.data-table').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('admin.leaders.index') }}",
          columns: [
              {data: 'id', name: 'id'},
              {data: 'name', name: 'name'},
