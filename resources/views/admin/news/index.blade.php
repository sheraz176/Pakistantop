...
@section('title')
    <title>News List | Pakistantop</title>
@endsection
@push('styles')
    <!-- Data table css -->
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button type="button" class="btn btn-success btn-sm" ><a Style="color:white;" href="{{ route('admin.news.create') }}">Create News</a></button>
